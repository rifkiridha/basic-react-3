...
export default function Login() {
    return (
        <div className='flex-col'>
            <InputForm label="Email or Password" name="email" type="text" placeholder="Your Email or Username" />
            <br />
            ...
            <p className="text-sm mt-5 text-center text-gray-800">
                <Link to="/secret/new" className="text-gray-350 font-bold">
            ...
            <div class="flex justify-center space-x-4">
                ...
                <button aria-label="Log in with Apple" class="p-3 rounded-sm">
